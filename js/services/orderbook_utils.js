...
exports.includesTokenAddress = function(assetData, tokenAddress) {
  var e_1, _a;
  var decodedAssetData =
      order_utils_1.assetDataUtils.decodeAssetDataOrThrow(assetData);
  if (order_utils_1.assetDataUtils.isMultiAssetData(decodedAssetData)) {
    try {
      for (var _b = __values(decodedAssetData.nestedAssetData.entries()),
               _c = _b.next();
           !_c.done; _c = _b.next()) {
        var _d = __read(_c.value, 2), nestedAssetDataElement = _d[1];
        if (exports.includesTokenAddress(nestedAssetDataElement,
                                         tokenAddress)) {
          return true;
        }
      }
    ...
    return false;
  } else if (!order_utils_1.assetDataUtils.isStaticCallAssetData(
                 decodedAssetData)) {
...
exports.deserializeOrder = function(signedOrderModel) {
  var signedOrder = {
    ...
    expirationTimeSeconds :
        new utils_1.BigNumber(signedOrderModel.expirationTimeSeconds),
  ...
  var apiOrder = {
    ...
    metaData : {
      ...
      remainingFillableTakerAssetAmount :
          signedOrderModel.remainingFillableTakerAssetAmount,
    },
  };
  return apiOrder;
};
exports.serializeOrder = function(apiOrder) {
  ...
  var signedOrderModel = new SignedOrderModel_1.SignedOrderModel({
    ...
    remainingFillableTakerAssetAmount :
        apiOrder.metaData.remainingFillableTakerAssetAmount.toString(),
  });
